...
The creation of such a resource requires several components: the ability to sequence hundreds of genomes with high quality, and the ability to select genomes to represent the genetic diversity human population.
...
\subsubsection{Variation graph representations}
...
\subsubsection{Graph construction methods}
...
Although these methods are not a focus of this thesis, I will briefly summarize some of the tools used in the analyses of my mapping algorithms.
...
Calling structural variants (SVs) is a more challenging problem, particularly around highly repetitive regions.
...
vg call is a graph-based genotyper primarily used for genotyping structural variants \cite{hickey_vgsv_2020}.
