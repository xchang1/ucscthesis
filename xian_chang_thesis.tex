...
For mapping long reads, this approach is intractable due to the cost of extending the alignment and clustering is generally replaced with a chaining step \cite{lr_review_2023}. 
